...
const css = "._3RHViq_section{flex-direction:column;gap:12px;height:100%;min-height:0;display:flex}._3RHViq_intro{color:var(--dsw-alias-label-secondary);margin:0;font-size:13px;line-height:20px}._3RHViq_search{width:100%}._3RHViq_list{flex-direction:column;flex:1;gap:16px;min-height:0;padding-right:4px;display:flex;overflow-y:auto}._3RHViq_group{flex-direction:column;gap:4px;display:flex}._3RHViq_groupLabel{color:var(--dsw-alias-label-tertiary);margin:0;padding:0 2px 2px;font-size:12px;font-weight:400;line-height:18px}._3RHViq_row{border:1px solid #0000;border-radius:10px}._3RHViq_rowOpen{border-color:var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1)}._3RHViq_rowSummary{width:100%;min-height:36px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;align-items:center;gap:10px;padding:6px 12px;font-size:13px;display:flex}._3RHViq_rowSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}._3RHViq_glyph{color:currentColor;flex-shrink:0}._3RHViq_darkOnly{display:none}body[data-ds-dark-theme] ._3RHViq_darkOnly{display:revert}body[data-ds-dark-theme] ._3RHViq_lightOnly{display:none}._3RHViq_monogram{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-secondary);border-radius:5px;flex-shrink:0;justify-content:center;align-items:center;font-size:10px;font-weight:600;line-height:1;display:inline-flex}._3RHViq_rowName{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}._3RHViq_rowStatus{color:var(--dsw-alias-label-tertiary);flex-shrink:0;font-size:12px}._3RHViq_chevron,._3RHViq_chevronOpen{color:var(--dsw-alias-label-tertiary);flex-shrink:0;transition:transform .15s}._3RHViq_chevronOpen{transform:rotate(180deg)}._3RHViq_badge{background:var(--dsw-alias-state-business-tertiary);height:18px;color:var(--dsw-alias-state-business-primary);border-radius:4px;flex-shrink:0;align-items:center;padding:0 6px;font-size:11px;line-height:18px;display:inline-flex}._3RHViq_card{flex-direction:column;gap:12px;padding:2px 12px 14px;display:flex}._3RHViq_meta{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;align-items:baseline;gap:6px;margin:0;font-size:12px;line-height:18px;display:flex}._3RHViq_factRef{color:var(--dsw-alias-label-tertiary);font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:12px}._3RHViq_warn{color:var(--dsw-alias-state-warn-label)}._3RHViq_error{color:var(--dsw-alias-state-error-primary)}._3RHViq_notice{background:var(--dsw-alias-state-warn-tertiary);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;padding:8px 10px;font-size:12px;line-height:18px;display:flex}._3RHViq_models{flex-direction:column;gap:6px;display:flex}._3RHViq_modelsHead{flex-wrap:wrap;align-items:center;gap:4px;display:flex}._3RHViq_modelsHead>button{white-space:nowrap;flex-shrink:0}._3RHViq_modelsLabel{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:500;line-height:18px}._3RHViq_grow{flex:1}._3RHViq_modelList{flex-direction:column;align-items:flex-start;gap:10px;width:100%;display:flex}._3RHViq_modelGroupLabel{color:var(--dsw-alias-label-tertiary);margin:0;padding:6px 0 2px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;line-height:16px}._3RHViq_modelGroupLabel:first-child{padding-top:0}._3RHViq_modelRows{background:var(--dsw-alias-bg-layer-1);border-radius:8px;flex-direction:column;width:100%;margin:0;padding:6px 10px;font-size:12px;line-height:20px;list-style:none;display:flex}._3RHViq_modelRow{align-items:baseline;gap:6px;min-width:0;padding:1px 0;display:flex}._3RHViq_modelName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._3RHViq_modelTag{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-tertiary);border-radius:4px;flex-shrink:0;align-self:center;padding:0 5px;font-size:10px;line-height:15px}._3RHViq_toolbar{align-items:center;gap:8px;display:flex}._3RHViq_toolbar>button{white-space:nowrap;flex-shrink:0}._3RHViq_catalogNotice{background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:6px 10px;font-size:12px;line-height:18px}._3RHViq_discover{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;padding:8px 10px;display:flex}._3RHViq_discoverInput{flex:1;min-width:220px}._3RHViq_discover ._3RHViq_hint{flex-basis:100%}._3RHViq_actions{flex-wrap:wrap;align-items:center;gap:8px;display:flex}._3RHViq_destructive{margin-left:auto}._3RHViq_checkboxRow{color:var(--dsw-alias-label-secondary);cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}._3RHViq_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:18px}._3RHViq_field{flex-direction:column;gap:6px;min-width:0;display:flex}._3RHViq_fieldLabel{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}._3RHViq_fieldControl{min-width:0;display:flex;position:relative}._3RHViq_fieldInput{flex:1;min-width:0}._3RHViq_fieldInput input{padding-right:34px}._3RHViq_reveal{width:26px;height:26px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:6px;justify-content:center;align-items:center;padding:0;display:inline-flex;position:absolute;top:50%;right:6px;transform:translateY(-50%)}._3RHViq_reveal:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}._3RHViq_confirmBody{flex-direction:column;gap:6px;min-width:0;display:flex}._3RHViq_wizard{flex-direction:column;gap:12px;width:100%;min-width:0;max-width:100%;display:flex}._3RHViq_wizardUrl{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:8px;flex-direction:column;gap:8px;min-width:0;padding:12px;display:flex}._3RHViq_wizardUrlText{min-width:0;max-height:132px;color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;line-height:16px;overflow-y:auto}._3RHViq_deviceCode{letter-spacing:2px;color:var(--dsw-alias-label-primary);font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:20px}._3RHViq_promptRow{align-items:center;gap:8px;min-width:0;display:flex}._3RHViq_promptInput{flex:auto;min-width:0}._3RHViq_promptSubmit{flex:none}._3RHViq_log{max-height:160px;color:var(--dsw-alias-label-tertiary);flex-direction:column;gap:2px;font-size:12px;line-height:18px;display:flex;overflow-y:auto}._3RHViq_optionList{flex-direction:column;gap:4px;display:flex}._3RHViq_option{border:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border-radius:8px;flex-direction:column;gap:2px;padding:8px;font-size:13px;display:flex}._3RHViq_option:hover{background:var(--dsw-alias-interactive-bg-hover)}._3RHViq_optionDescription{color:var(--dsw-alias-label-tertiary);font-size:12px}._3RHViq_seatRoot{display:inline-flex;position:relative}._3RHViq_seatTrigger{max-width:260px;height:26px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;align-items:center;gap:6px;padding:0 8px;font-size:12px;line-height:18px;display:inline-flex}._3RHViq_seatTrigger:hover{background:var(--dsw-alias-interactive-bg-hover)}._3RHViq_seatTrigger:disabled{cursor:default;opacity:.6}._3RHViq_seatTriggerLabel{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._3RHViq_seatTriggerEffort{color:var(--dsw-alias-label-tertiary);flex-shrink:0}._3RHViq_seatChevron,._3RHViq_seatChevronOpen{color:var(--dsw-alias-label-tertiary);flex-shrink:0;transition:transform .15s}._3RHViq_seatChevronOpen{transform:rotate(180deg)}._3RHViq_seatMenu{z-index:30;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);border-radius:10px;flex-direction:column;min-width:260px;max-width:340px;padding:4px;display:flex;position:absolute;bottom:calc(100% + 6px);right:0;box-shadow:0 8px 24px #0000001f}._3RHViq_seatCell{color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;align-items:center;gap:8px;padding:7px 10px;font-size:12px;line-height:18px;display:flex}._3RHViq_seatCell:hover{background:var(--dsw-alias-interactive-bg-hover)}._3RHViq_seatCellLabel{color:var(--dsw-alias-label-secondary);flex-shrink:0}._3RHViq_seatCellValue{flex:1;justify-content:flex-end;align-items:center;gap:6px;min-width:0;display:inline-flex}._3RHViq_seatCellValue>:first-child{flex-shrink:0}._3RHViq_seatCellValueText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}._3RHViq_seatCellChevron{color:var(--dsw-alias-label-tertiary);flex-shrink:0}._3RHViq_seatGroups{max-height:320px;overflow-y:auto}._3RHViq_seatGroup{flex-direction:column;display:flex}._3RHViq_seatGroupTitle{color:var(--dsw-alias-label-tertiary);align-items:center;gap:6px;padding:8px 10px 4px;font-size:11px;line-height:16px;display:flex}._3RHViq_seatOption{width:100%;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;align-items:center;gap:8px;padding:6px 10px;font-size:12px;line-height:18px;display:flex}._3RHViq_seatOption:hover{background:var(--dsw-alias-interactive-bg-hover)}._3RHViq_seatOption:disabled{cursor:default;opacity:.6}._3RHViq_seatSelected{color:var(--dsw-alias-label-primary);font-weight:500}._3RHViq_seatOptionCopy{flex-direction:column;flex:1;min-width:0;display:flex}._3RHViq_seatOptionName{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._3RHViq_seatOptionDescription{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:15px;overflow:hidden}._3RHViq_seatCheck{width:16px;color:var(--dsw-alias-state-business-primary);flex-shrink:0}._3RHViq_seatStatus,._3RHViq_seatEmpty{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:12px;line-height:18px}._3RHViq_seatError,._3RHViq_seatWarning{align-items:center;gap:8px;padding:6px 10px;font-size:12px;line-height:18px;display:flex}._3RHViq_seatError{color:var(--dsw-alias-state-error-primary)}._3RHViq_seatWarning{color:var(--dsw-alias-state-warn-label)}._3RHViq_seatRetry{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;flex-shrink:0;padding:0;font-size:12px;text-decoration:underline}._3RHViq_usageCard{appearance:none;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:linear-gradient(165deg, color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, transparent), transparent 60%), var(--dsw-alias-bg-layer-1);min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-primary);cursor:pointer;animation:_3RHViq_usage-card-in .2s var(--ds-ease-in-out,ease) backwards;transition:background .15s var(--ds-ease-in-out,ease);border-radius:12px;flex:1;margin:0 2px 8px;padding:10px 12px;font-size:12px;line-height:16px;position:relative}._3RHViq_usageCard:hover{background:var(--dsw-alias-interactive-bg-hover)}._3RHViq_usageCard:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._3RHViq_usageRailButton{appearance:none;width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;transition:background .15s var(--ds-ease-in-out,ease), color .15s var(--ds-ease-in-out,ease);background:0 0;border:none;border-radius:8px;place-items:center;margin:0 auto 8px;padding:0;display:grid}._3RHViq_usageRailButton:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._3RHViq_usageRailButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}@keyframes _3RHViq_usage-card-in{0%{opacity:0;transform:translateY(4px)}}._3RHViq_usageHead{align-items:baseline;gap:6px;display:flex}._3RHViq_usageTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-secondary);flex:1;font-weight:500;overflow:hidden}._3RHViq_usageAlert{color:var(--dsw-alias-state-error-primary);flex:none;font-weight:600}._3RHViq_usageCost{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-secondary);flex:none}._3RHViq_usageTotal{font-variant-numeric:tabular-nums;margin-top:2px;font-size:18px;font-weight:600}._3RHViq_usageTrend{margin-top:6px}._3RHViq_usageSpark{height:28px;position:relative}._3RHViq_usageSpark svg{width:100%;height:100%;display:block}._3RHViq_usageSparkDot{background:var(--dsw-alias-state-business-primary);border:2px solid var(--dsw-alias-bg-layer-1);border-radius:50%;width:7px;height:7px;position:absolute;right:-6px;transform:translateY(-50%)}._3RHViq_usageBar{background:var(--dsw-alias-interactive-bg-hover);border-radius:999px;height:4px;margin-top:8px;display:flex;overflow:hidden}._3RHViq_usageBar>span{height:100%;animation:_3RHViq_usage-fill-in .45s var(--ds-ease-in-out,ease) backwards;transition:width .45s var(--ds-ease-in-out,ease);display:block}@keyframes _3RHViq_usage-fill-in{0%{width:0}}._3RHViq_usageGrid{grid-template-columns:1fr 1fr;gap:4px 10px;margin:8px 0 0;display:grid}._3RHViq_usageEntry{align-items:center;gap:5px;min-width:0;display:flex}._3RHViq_usageDot{border-radius:50%;flex:none;width:6px;height:6px}._3RHViq_usageLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:1;overflow:hidden}._3RHViq_usageValue{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-secondary);margin:0}._3RHViq_usageModal._3RHViq_usageModal{width:min(1180px,100vw - 32px);max-width:none}._3RHViq_usageModalContent._3RHViq_usageModalContent{overscroll-behavior:contain;max-height:calc(100dvh - 160px);overflow-y:auto}._3RHViq_usageModalFrame._3RHViq_usageModalFrame{flex-direction:column;height:calc(100dvh - 96px);max-height:calc(100dvh - 96px);display:flex;overflow:hidden}._3RHViq_usageModalFrame>div:last-child{flex:1;min-height:0}._3RHViq_usageDialogBody{flex-direction:column;flex:1;gap:16px;min-height:0;font-size:12px;line-height:16px;display:flex}._3RHViq_usageLayout{flex:1;grid-template-columns:148px minmax(0,1fr);gap:20px;min-height:0;display:grid}._3RHViq_usageContent{overscroll-behavior:contain;scrollbar-width:thin;flex-direction:column;gap:16px;min-width:0;min-height:0;display:flex;overflow-y:auto}._3RHViq_usageTabs{flex-direction:column;align-self:start;gap:2px;display:flex}._3RHViq_usageTab,._3RHViq_usageTabActive{appearance:none;width:100%;font:inherit;text-align:left;color:var(--dsw-alias-label-tertiary);cursor:pointer;transition:background .15s var(--ds-ease-in-out,ease), color .15s var(--ds-ease-in-out,ease);background:0 0;border:none;border-radius:8px;padding:8px 12px;font-size:13px}._3RHViq_usageTab:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}._3RHViq_usageTabActive{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary);font-weight:600;box-shadow:0 1px 2px #00000014}._3RHViq_usageTopRow{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;display:flex}._3RHViq_usageTopRow>._3RHViq_usageWindowRow{margin-left:auto}._3RHViq_usageEmptyState{text-align:center;color:var(--dsw-alias-label-tertiary);margin:0;padding:44px 0;font-size:13px;line-height:20px}._3RHViq_usageInsights{flex-wrap:wrap;gap:6px;display:flex}._3RHViq_usageChip{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:2px 10px;font-size:11px;line-height:18px}._3RHViq_usageHero{border:1px solid var(--dsw-alias-border-l1);background:linear-gradient(165deg, color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent), transparent 55%), var(--dsw-alias-bg-layer-1);border-radius:18px;min-width:0;padding:20px 22px 16px}._3RHViq_usageHeroStats{align-items:baseline;gap:44px;display:flex}._3RHViq_usageHeroStat{flex-direction:column;gap:2px;min-width:0;display:flex}._3RHViq_usageHeroLabel{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}._3RHViq_usageHeroNumber{font-variant-numeric:tabular-nums;white-space:nowrap;font-size:30px;font-weight:600;line-height:1.15}._3RHViq_usageHeroHead{justify-content:space-between;align-items:center;gap:10px;margin:18px 0 10px;display:flex}._3RHViq_usageHeroFoot{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex-wrap:wrap;gap:4px 18px;margin-top:12px;font-size:11px;line-height:16px;display:flex}._3RHViq_usageLegend{flex-wrap:wrap;gap:4px 18px;margin-top:10px;display:flex}._3RHViq_usageLegendItem{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;line-height:16px;display:inline-flex}._3RHViq_usageLegendName{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._3RHViq_usageLegendItem ._3RHViq_usageValue{color:var(--dsw-alias-label-primary)}._3RHViq_usagePanel{border:1px solid var(--dsw-alias-border-l1);background:linear-gradient(165deg, color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent), transparent 55%), var(--dsw-alias-bg-layer-1);border-radius:16px;min-width:0;padding:16px 18px}._3RHViq_usagePanelHead{justify-content:space-between;align-items:center;gap:10px;margin-bottom:12px;display:flex}._3RHViq_usagePanelHead ._3RHViq_usageHeading{flex:1;margin-bottom:0}._3RHViq_usageMiniList{flex-direction:column;gap:7px;margin-top:12px;display:flex}._3RHViq_usageMiniRow{grid-template-columns:auto minmax(60px,1fr) minmax(40px,96px) 44px 68px;align-items:center;gap:6px;min-width:0;display:grid}._3RHViq_usageMiniRow ._3RHViq_usageShare,._3RHViq_usageMiniRow ._3RHViq_usageNum{text-align:right}._3RHViq_usageMiniTrack{background:var(--dsw-alias-interactive-bg-hover);border-radius:999px;height:4px;overflow:hidden}._3RHViq_usageMiniTrack>span{border-radius:999px;height:100%;display:block}._3RHViq_usageCalendar{scrollbar-width:thin;max-width:100%;overflow-x:auto}._3RHViq_usageCalendarGrid{flex-direction:column;gap:4px;min-width:max-content;padding:2px 1px 1px;display:flex;position:relative}._3RHViq_usageCalendarMonthRow{gap:4px;margin-bottom:2px;display:grid}._3RHViq_usageCalendarMonth{text-align:center;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:14px}._3RHViq_usageCalendarBody{gap:4px;display:flex}._3RHViq_usageCalendarWeekdays{flex-direction:column;flex:none;gap:4px;width:22px;display:flex}._3RHViq_usageCalendarWeekdays>span{height:12px;color:var(--dsw-alias-label-tertiary);font-size:9px;line-height:12px}._3RHViq_usageCalendarWeekRow{gap:4px;display:flex;position:relative}._3RHViq_usageCalendarWeek{flex-direction:column;gap:4px;display:flex}._3RHViq_usageCalendarCell{background:var(--dsw-alias-bg-layer-2);width:12px;height:12px;transition:transform .12s var(--ds-ease-in-out,ease);border-radius:3px;flex:none}._3RHViq_usageCalendarCell:hover{transform:scale(1.15)}._3RHViq_usageCalendarLegend{align-items:center;gap:3px;display:inline-flex}._3RHViq_usageCalendarLegendText{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}._3RHViq_usageCalendarLegendSwatch{border-radius:3px;width:12px;height:12px}._3RHViq_usageWeekHours{grid-template-columns:36px repeat(24,minmax(0,1fr));align-items:center;gap:2px;display:grid}._3RHViq_usageWeekHead{text-align:center;color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:14px}._3RHViq_usageWeekDay{text-align:right;white-space:nowrap;color:var(--dsw-alias-label-tertiary);padding-right:3px;font-size:10px;line-height:14px}._3RHViq_usageWeekCell{aspect-ratio:1;background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 7%, transparent);border-radius:2px}._3RHViq_usageArea{border-bottom:1px solid var(--dsw-alias-border-l1);height:260px;position:relative}._3RHViq_usageAreaSvg{width:100%;height:100%;display:block}._3RHViq_usageAreaLine{z-index:1;background:var(--dsw-alias-interactive-bg-hover);pointer-events:none;width:1px;position:absolute;top:0;bottom:0}._3RHViq_usageAreaDot{z-index:1;background:var(--dsw-alias-bg-layer-1);border:2px solid var(--dsw-alias-state-business-primary);pointer-events:none;border-radius:50%;width:8px;height:8px;position:absolute;transform:translate(-50%,-50%)}._3RHViq_usageDonutRow{grid-template-columns:150px minmax(0,1fr);align-items:center;gap:24px;display:grid}._3RHViq_usageDonutRow>._3RHViq_usageDonut{margin:0 auto}._3RHViq_usageMain3[hidden],._3RHViq_usageSessionStats[hidden]{display:none}._3RHViq_usageMain3{grid-template-columns:minmax(0,1fr);align-items:start;gap:16px;display:grid}._3RHViq_usageWindowRow{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:9px;gap:2px;padding:2px;display:inline-flex}._3RHViq_usageWindowChoice,._3RHViq_usageWindowActive{appearance:none;font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;transition:background .15s var(--ds-ease-in-out,ease), color .15s var(--ds-ease-in-out,ease);background:0 0;border:none;border-radius:7px;padding:3px 12px;font-size:12px}._3RHViq_usageWindowChoice:hover{background:var(--dsw-alias-interactive-bg-hover)}._3RHViq_usageWindowActive{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary);box-shadow:0 1px 2px #00000014}._3RHViq_usageDelta{border-radius:999px;align-items:center;gap:2px;margin-left:6px;padding:1px 7px;font-size:11px;font-weight:600;display:inline-flex}._3RHViq_usageDeltaGood{color:var(--dsw-alias-state-success-primary);background:var(--dsw-alias-state-success-tertiary)}._3RHViq_usageDeltaBad{color:var(--dsw-alias-state-warn-primary);background:var(--dsw-alias-state-warn-tertiary)}._3RHViq_usageHeading{color:var(--dsw-alias-label-primary);align-items:center;gap:6px;margin-bottom:10px;font-size:13px;font-weight:600;display:flex}._3RHViq_usageHeading:before{content:\"\";background:var(--dsw-alias-state-business-primary);border-radius:2px;flex:none;width:3px;height:13px}._3RHViq_usageHeadingCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;margin-left:auto;font-size:11px;font-weight:400}._3RHViq_usageChart{border-bottom:1px solid var(--dsw-alias-border-l1);scrollbar-width:thin;align-items:stretch;gap:4px;height:260px;display:flex;position:relative;overflow-x:auto}._3RHViq_usageChartGrid{z-index:0;pointer-events:none;position:absolute;inset:0}._3RHViq_usageChartGrid>span{border-top:1px dashed var(--dsw-alias-border-l2);position:absolute;left:0;right:0}._3RHViq_usageTip{z-index:2;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);pointer-events:none;min-width:156px;max-width:240px;animation:_3RHViq_usage-tip-in .12s var(--ds-ease-in-out,ease) backwards;border-radius:8px;flex-direction:column;gap:3px;padding:8px 10px;font-size:11px;line-height:15px;display:flex;position:absolute;top:0;box-shadow:0 8px 24px #0000001f}@keyframes _3RHViq_usage-tip-in{0%{opacity:0}}._3RHViq_usageTipDate{color:var(--dsw-alias-label-primary);font-weight:500}._3RHViq_usageTipRow{align-items:center;gap:6px;min-width:0;display:flex}._3RHViq_usageTipName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-secondary);overflow:hidden}._3RHViq_usageTipShare{white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;margin-left:auto;padding-left:8px}._3RHViq_usageTipFoot{border-top:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;gap:8px;margin-top:2px;padding-top:4px;display:flex}._3RHViq_usageChartCol{flex-direction:column;flex:1;justify-content:flex-end;min-width:3px;display:flex}._3RHViq_usageChartFill{width:100%;min-height:3px;animation:_3RHViq_usage-rise .45s var(--ds-ease-in-out,ease) backwards;transition:opacity .15s var(--ds-ease-in-out,ease);border-radius:4px 4px 0 0;flex-direction:column-reverse;display:flex;overflow:hidden}._3RHViq_usageChartCol:hover ._3RHViq_usageChartFill{opacity:.85}._3RHViq_usageChartFill>span{width:100%;display:block}@keyframes _3RHViq_usage-rise{0%{height:0}}._3RHViq_usageChartAxis{color:var(--dsw-alias-label-tertiary);justify-content:space-between;margin-top:4px;font-size:11px;display:flex}._3RHViq_usageAxisToday{color:var(--dsw-alias-label-secondary);align-items:center;gap:4px;display:inline-flex}._3RHViq_usageAxisToday:before{content:\"\";background:var(--dsw-alias-state-business-primary);border-radius:50%;width:5px;height:5px}._3RHViq_usageDonut{width:140px;height:140px;position:relative}._3RHViq_usageDonutSvg{width:100%;height:100%;transform:rotate(-90deg)}._3RHViq_usageDonutSegment{transition:stroke-dasharray .6s var(--ds-ease-in-out,ease)}._3RHViq_usageDonutCenter{pointer-events:none;flex-direction:column;justify-content:center;align-items:center;gap:2px;display:flex;position:absolute;inset:0}._3RHViq_usageDonutCenter ._3RHViq_usageLabel{flex:none}._3RHViq_usageDonutValue{font-variant-numeric:tabular-nums;font-size:19px;font-weight:600}._3RHViq_usageList{gap:6px 8px;min-width:0;display:grid}._3RHViq_usageListModel{grid-template-columns:minmax(0,1fr) 56px minmax(80px,auto) minmax(56px,auto) minmax(64px,auto)}._3RHViq_usageListCell{color:var(--dsw-alias-label-tertiary);padding-bottom:2px;font-size:11px}._3RHViq_usageListSubagents{grid-template-columns:minmax(0,1fr) repeat(5,minmax(52px,auto))}._3RHViq_usageRowTag{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-tertiary);white-space:nowrap;border-radius:4px;margin-left:6px;padding:0 5px;font-size:10px;line-height:15px}._3RHViq_usageRowStrong{color:var(--dsw-alias-label-primary);font-weight:600}._3RHViq_usageListMain{align-items:center;gap:6px;min-width:0;display:flex}._3RHViq_usageList>._3RHViq_usageModelTrack{grid-column:1/-1}._3RHViq_usageNum{text-align:right;font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-secondary)}._3RHViq_usageShare{text-align:right;font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-tertiary)}._3RHViq_usageModelName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-weight:500;overflow:hidden}._3RHViq_usageModelTrack{background:var(--dsw-alias-interactive-bg-hover);border-radius:999px;height:4px;margin-top:4px;overflow:hidden}._3RHViq_usageModelBar{background:var(--dsw-alias-state-business-primary);min-width:3px;height:100%;animation:_3RHViq_usage-fill-in .45s var(--ds-ease-in-out,ease) backwards;transition:width .45s var(--ds-ease-in-out,ease);border-radius:999px;display:block}._3RHViq_usageTable{grid-template-columns:1fr auto auto auto auto auto auto auto;gap:4px 16px;display:grid}._3RHViq_usageTable ._3RHViq_usageValue{text-align:right}._3RHViq_usageCellValue{flex-direction:column;justify-content:center;align-items:flex-end;gap:3px;min-width:0;display:flex}._3RHViq_usageCellBar{background:var(--dsw-alias-interactive-bg-hover);border-radius:999px;width:64px;height:4px;display:block;overflow:hidden}._3RHViq_usageCellBar>span{background:var(--dsw-alias-state-business-primary);border-radius:999px;height:100%;display:block}._3RHViq_usagePeak{color:var(--dsw-alias-label-primary);font-weight:600}._3RHViq_usageTableHead{color:var(--dsw-alias-label-tertiary)}._3RHViq_usageTable>._3RHViq_usageTableHead:not(:first-child){text-align:right}._3RHViq_usageTableRow{display:contents}._3RHViq_usageStatus{clip-path:inset(50%);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){._3RHViq_usageCard,._3RHViq_usageBar>span,._3RHViq_usageChartFill,._3RHViq_usageModelBar,._3RHViq_usageDonutSegment,._3RHViq_usageTip,._3RHViq_usageCalendarCell{transition:none;animation:none}}._3RHViq_usageVariantStellar ._3RHViq_usageHero{background:linear-gradient(165deg, color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent), transparent 60%), var(--dsw-alias-bg-layer-1);border-radius:22px;padding:24px 26px 20px}._3RHViq_usageVariantStellar ._3RHViq_usageHeroNumber{font-size:40px}._3RHViq_usageVariantStellar ._3RHViq_usageHeroStats{gap:56px}._3RHViq_usageVariantStellar ._3RHViq_usageChart,._3RHViq_usageVariantStellar ._3RHViq_usageArea{height:320px}._3RHViq_usageVariantStellar ._3RHViq_usagePanel{border-radius:20px;padding:22px 24px}._3RHViq_usageVariantStellar ._3RHViq_usageTabs{gap:4px}._3RHViq_usageVariantStellar ._3RHViq_usageTab,._3RHViq_usageVariantStellar ._3RHViq_usageTabActive{padding:10px 14px;font-size:14px}._3RHViq_usageVariantStellar ._3RHViq_usageDonutRow{grid-template-columns:180px minmax(0,1fr)}._3RHViq_usageVariantStellar ._3RHViq_usageMiniTrack{height:6px}._3RHViq_usageVariantStellar ._3RHViq_usageLegendItem{font-size:12px}._3RHViq_usageVariantStellar ._3RHViq_usageHeroHead{margin:22px 0 12px}._3RHViq_usageDrillStat{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:10px;flex-direction:column;gap:2px;min-width:0;padding:10px 12px;display:flex}._3RHViq_usageDrillKind{align-items:center;gap:6px;display:inline-flex}._3RHViq_usageDrillValue{text-overflow:ellipsis;white-space:nowrap;font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-primary);font-size:17px;font-weight:600;overflow:hidden}._3RHViq_usageSessionView{box-sizing:border-box;width:100%;max-width:748px;margin:0 auto;padding:20px 16px 32px}._3RHViq_usageSessionBody{flex-direction:column;gap:14px;font-size:12px;line-height:16px;display:flex}._3RHViq_usageSessionHead{flex-direction:column;gap:4px;min-width:0;padding:6px 2px 0;display:flex}._3RHViq_usageSessionBody ._3RHViq_usageHero{flex-direction:column;gap:14px;display:flex}._3RHViq_usageSessionBody ._3RHViq_usageHero ._3RHViq_usageLegend{margin-top:-6px}._3RHViq_usageSessionName{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;overflow:hidden}._3RHViq_usageSessionMeta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:11px;overflow:hidden}._3RHViq_usageSessionStats{grid-template-columns:repeat(auto-fit,minmax(110px,1fr));gap:8px;display:grid}@media (width<=760px){._3RHViq_usageModal._3RHViq_usageModal{width:calc(100vw - 16px)}._3RHViq_usageModalFrame._3RHViq_usageModalFrame{height:calc(100dvh - 32px);max-height:calc(100dvh - 32px)}._3RHViq_usageLayout{grid-template-columns:minmax(0,1fr);gap:12px}._3RHViq_usageTabs{scrollbar-width:none;flex-direction:row;overflow-x:auto}._3RHViq_usageTab,._3RHViq_usageTabActive{white-space:nowrap;width:auto}._3RHViq_usageHeroStats{flex-wrap:wrap;gap:20px}._3RHViq_usageHeroStat{flex:42%}._3RHViq_usageHeroNumber{font-size:24px}._3RHViq_usageHeroHead{flex-wrap:wrap}._3RHViq_usageChart,._3RHViq_usageArea{height:170px}._3RHViq_usageDonutRow,._3RHViq_usageSessionStats{grid-template-columns:repeat(2,minmax(0,1fr))}._3RHViq_usageVariantStellar ._3RHViq_usageHeroNumber{font-size:28px}._3RHViq_usageVariantStellar ._3RHViq_usageChart,._3RHViq_usageVariantStellar ._3RHViq_usageArea{height:200px}._3RHViq_usageTable{min-width:560px}._3RHViq_usageList{min-width:640px}}._3RHViq_usageTimeline{width:100%;height:auto;display:block}._3RHViq_usageTimelineAxis{stroke:var(--dsw-alias-border-l1)}._3RHViq_usageTimelineLabel{fill:var(--dsw-alias-label-tertiary);font-size:10px}._3RHViq_usageTimelineArea{fill:var(--dsw-alias-label-primary);opacity:.07;stroke:none}._3RHViq_usageTimelineLine{fill:none;stroke:var(--dsw-alias-label-primary);stroke-width:2px;stroke-linejoin:round;stroke-linecap:round;vector-effect:non-scaling-stroke}._3RHViq_usageTimelineFrame{position:relative}._3RHViq_usageTimelineGrid{stroke:var(--dsw-alias-border-l2);stroke-dasharray:3 4}._3RHViq_usageTimelineLabelLine{fill:var(--dsw-alias-label-primary);font-size:10px}._3RHViq_usageTimelineContext{fill:none;stroke:var(--dsw-alias-label-secondary);stroke-width:1.5px;stroke-dasharray:4 3;stroke-linejoin:round;vector-effect:non-scaling-stroke}._3RHViq_usageTimelineBrush{z-index:1;background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent);border-inline:1px solid var(--dsw-alias-state-business-primary);pointer-events:none;position:absolute}._3RHViq_usageTimelineSwatchLine{border-top:2px solid var(--dsw-alias-label-primary);width:14px;height:0}._3RHViq_usageTimelineSwatchContext{border-top:2px dashed var(--dsw-alias-label-secondary);width:14px;height:0}._3RHViq_usagePickable{cursor:pointer}button._3RHViq_usageMiniRow{width:100%;font:inherit;color:inherit;text-align:left;background:0 0;border:0;padding:0}._3RHViq_usagePickable:hover ._3RHViq_usageModelName,._3RHViq_usagePicked ._3RHViq_usageModelName{color:var(--dsw-alias-state-business-primary)}._3RHViq_usageList ._3RHViq_usagePicked{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent)}._3RHViq_usagePicked._3RHViq_usageCalendarCell{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}";
...
var AccountsSection_module_css_default = {
	...
	"usage-card-in": "_3RHViq_usage-card-in",
	"usage-fill-in": "_3RHViq_usage-fill-in",
	"usage-rise": "_3RHViq_usage-rise",
	"usage-tip-in": "_3RHViq_usage-tip-in",
	"usageAlert": "_3RHViq_usageAlert",
	"usageArea": "_3RHViq_usageArea",
	"usageAreaDot": "_3RHViq_usageAreaDot",
	"usageAreaLine": "_3RHViq_usageAreaLine",
	"usageAreaSvg": "_3RHViq_usageAreaSvg",
	"usageAxisToday": "_3RHViq_usageAxisToday",
	"usageBar": "_3RHViq_usageBar",
	"usageCalendar": "_3RHViq_usageCalendar",
	"usageCalendarBody": "_3RHViq_usageCalendarBody",
	"usageCalendarCell": "_3RHViq_usageCalendarCell",
	"usageCalendarGrid": "_3RHViq_usageCalendarGrid",
	"usageCalendarLegend": "_3RHViq_usageCalendarLegend",
	"usageCalendarLegendSwatch": "_3RHViq_usageCalendarLegendSwatch",
	"usageCalendarLegendText": "_3RHViq_usageCalendarLegendText",
	"usageCalendarMonth": "_3RHViq_usageCalendarMonth",
	"usageCalendarMonthRow": "_3RHViq_usageCalendarMonthRow",
	"usageCalendarWeek": "_3RHViq_usageCalendarWeek",
	"usageCalendarWeekdays": "_3RHViq_usageCalendarWeekdays",
	"usageCalendarWeekRow": "_3RHViq_usageCalendarWeekRow",
	"usageCard": "_3RHViq_usageCard",
	"usageCellBar": "_3RHViq_usageCellBar",
	"usageCellValue": "_3RHViq_usageCellValue",
	"usageChart": "_3RHViq_usageChart",
	"usageChartAxis": "_3RHViq_usageChartAxis",
	"usageChartCol": "_3RHViq_usageChartCol",
	"usageChartFill": "_3RHViq_usageChartFill",
	"usageChartGrid": "_3RHViq_usageChartGrid",
	"usageChip": "_3RHViq_usageChip",
	"usageContent": "_3RHViq_usageContent",
	"usageCost": "_3RHViq_usageCost",
	"usageDelta": "_3RHViq_usageDelta",
	"usageDeltaBad": "_3RHViq_usageDeltaBad",
	"usageDeltaGood": "_3RHViq_usageDeltaGood",
	"usageDialogBody": "_3RHViq_usageDialogBody",
	"usageDonut": "_3RHViq_usageDonut",
	"usageDonutCenter": "_3RHViq_usageDonutCenter",
	"usageDonutRow": "_3RHViq_usageDonutRow",
	"usageDonutSegment": "_3RHViq_usageDonutSegment",
	"usageDonutSvg": "_3RHViq_usageDonutSvg",
	"usageDonutValue": "_3RHViq_usageDonutValue",
	"usageDot": "_3RHViq_usageDot",
	"usageDrillKind": "_3RHViq_usageDrillKind",
	"usageDrillStat": "_3RHViq_usageDrillStat",
	"usageDrillValue": "_3RHViq_usageDrillValue",
	"usageEmptyState": "_3RHViq_usageEmptyState",
	"usageEntry": "_3RHViq_usageEntry",
	"usageGrid": "_3RHViq_usageGrid",
	"usageHead": "_3RHViq_usageHead",
	"usageHeading": "_3RHViq_usageHeading",
	"usageHeadingCount": "_3RHViq_usageHeadingCount",
	"usageHero": "_3RHViq_usageHero",
	"usageHeroFoot": "_3RHViq_usageHeroFoot",
	"usageHeroHead": "_3RHViq_usageHeroHead",
	"usageHeroLabel": "_3RHViq_usageHeroLabel",
	"usageHeroNumber": "_3RHViq_usageHeroNumber",
	"usageHeroStat": "_3RHViq_usageHeroStat",
	"usageHeroStats": "_3RHViq_usageHeroStats",
	"usageInsights": "_3RHViq_usageInsights",
	"usageLabel": "_3RHViq_usageLabel",
	"usageLayout": "_3RHViq_usageLayout",
	"usageLegend": "_3RHViq_usageLegend",
	"usageLegendItem": "_3RHViq_usageLegendItem",
	"usageLegendName": "_3RHViq_usageLegendName",
	"usageList": "_3RHViq_usageList",
	"usageListCell": "_3RHViq_usageListCell",
	"usageListMain": "_3RHViq_usageListMain",
	"usageListModel": "_3RHViq_usageListModel",
	"usageListSubagents": "_3RHViq_usageListSubagents",
	"usageMain3": "_3RHViq_usageMain3",
	"usageMiniList": "_3RHViq_usageMiniList",
	"usageMiniRow": "_3RHViq_usageMiniRow",
	"usageMiniTrack": "_3RHViq_usageMiniTrack",
	"usageModal": "_3RHViq_usageModal",
	"usageModalContent": "_3RHViq_usageModalContent",
	"usageModalFrame": "_3RHViq_usageModalFrame",
	"usageModelBar": "_3RHViq_usageModelBar",
	"usageModelName": "_3RHViq_usageModelName",
	"usageModelTrack": "_3RHViq_usageModelTrack",
	"usageNum": "_3RHViq_usageNum",
	"usagePanel": "_3RHViq_usagePanel",
	"usagePanelHead": "_3RHViq_usagePanelHead",
	"usagePeak": "_3RHViq_usagePeak",
	"usagePickable": "_3RHViq_usagePickable",
	"usagePicked": "_3RHViq_usagePicked",
	"usageRailButton": "_3RHViq_usageRailButton",
	"usageRowStrong": "_3RHViq_usageRowStrong",
	"usageRowTag": "_3RHViq_usageRowTag",
	"usageSessionBody": "_3RHViq_usageSessionBody",
	"usageSessionHead": "_3RHViq_usageSessionHead",
	"usageSessionMeta": "_3RHViq_usageSessionMeta",
	"usageSessionName": "_3RHViq_usageSessionName",
	"usageSessionStats": "_3RHViq_usageSessionStats",
	"usageSessionView": "_3RHViq_usageSessionView",
	"usageShare": "_3RHViq_usageShare",
	"usageSpark": "_3RHViq_usageSpark",
	"usageSparkDot": "_3RHViq_usageSparkDot",
	"usageStatus": "_3RHViq_usageStatus",
	"usageTab": "_3RHViq_usageTab",
	"usageTabActive": "_3RHViq_usageTabActive",
	"usageTable": "_3RHViq_usageTable",
	"usageTableHead": "_3RHViq_usageTableHead",
	"usageTableRow": "_3RHViq_usageTableRow",
	"usageTabs": "_3RHViq_usageTabs",
	"usageTimeline": "_3RHViq_usageTimeline",
	"usageTimelineArea": "_3RHViq_usageTimelineArea",
	"usageTimelineAxis": "_3RHViq_usageTimelineAxis",
	"usageTimelineBrush": "_3RHViq_usageTimelineBrush",
	"usageTimelineContext": "_3RHViq_usageTimelineContext",
	"usageTimelineFrame": "_3RHViq_usageTimelineFrame",
	"usageTimelineGrid": "_3RHViq_usageTimelineGrid",
	"usageTimelineLabel": "_3RHViq_usageTimelineLabel",
	"usageTimelineLabelLine": "_3RHViq_usageTimelineLabelLine",
	"usageTimelineLine": "_3RHViq_usageTimelineLine",
	"usageTimelineSwatchContext": "_3RHViq_usageTimelineSwatchContext",
	"usageTimelineSwatchLine": "_3RHViq_usageTimelineSwatchLine",
	"usageTip": "_3RHViq_usageTip",
	"usageTipDate": "_3RHViq_usageTipDate",
	"usageTipFoot": "_3RHViq_usageTipFoot",
	"usageTipName": "_3RHViq_usageTipName",
	"usageTipRow": "_3RHViq_usageTipRow",
	"usageTipShare": "_3RHViq_usageTipShare",
	"usageTitle": "_3RHViq_usageTitle",
	"usageTopRow": "_3RHViq_usageTopRow",
	"usageTotal": "_3RHViq_usageTotal",
	"usageTrend": "_3RHViq_usageTrend",
	"usageValue": "_3RHViq_usageValue",
	"usageVariantStellar": "_3RHViq_usageVariantStellar",
	"usageWeekCell": "_3RHViq_usageWeekCell",
	"usageWeekDay": "_3RHViq_usageWeekDay",
	"usageWeekHead": "_3RHViq_usageWeekHead",
	"usageWeekHours": "_3RHViq_usageWeekHours",
	"usageWindowActive": "_3RHViq_usageWindowActive",
	"usageWindowChoice": "_3RHViq_usageWindowChoice",
	"usageWindowRow": "_3RHViq_usageWindowRow",
	"warn": "_3RHViq_warn",
